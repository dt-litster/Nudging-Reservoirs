  ...
  do
    ...
    do
      ...
      do
          ...
          python ./train_node.py $SAVE_EXT -w $WIDTH --num_epochs=$NUM_EPOCHS --save_every=$SAVE_EVERY --val_every=$NUM_EPOCHS -ws $WFN -lr $LR --weight_decay $WD
